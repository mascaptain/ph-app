...
export const DB = [
  // KETTLEBELL (25)
  {id:"kb01",n:"Swing KB",m:"Fessiers · Ischios",eq:"kb",kg:20,reps:"15",rest:60,rpe:7,cue:"Deux mains sur la poignée. Poussée de hanches explosive, dos neutre, KB à hauteur d'épaules."},
  {id:"kb02",n:"Swing KB unilatéral",m:"Fessiers · Core",eq:"kb",kg:16,reps:"10",rest:60,rpe:7,cue:"Une main, changement de main à mi-série. Résiste à la rotation du tronc."},
  {id:"kb03",n:"Clean KB",m:"Full body",eq:"kb",kg:16,reps:"8",rest:90,rpe:7,cue:"Une main, moitié des reps par côté. KB tracte sur le côté, vient en rack sans impact au poignet."},
  {id:"kb04",n:"Clean & Press KB",m:"Épaules · Full body",eq:"kb",kg:14,reps:"6",rest:120,rpe:8,cue:"Une main, moitié des reps par côté. Clean + press vertical, core serré."},
  {id:"kb05",n:"Push Press KB",m:"Épaules · Jambes",eq:"kb",kg:16,reps:"8",rest:90,rpe:7,cue:"Une main, moitié des reps par côté. Légère impulsion jambes, bras verrouillé en haut, descente lente."},
  {id:"kb06",n:"Snatch KB",m:"Full body",eq:"kb",kg:12,reps:"5",rest:120,rpe:8,cue:"Une main, moitié des reps par côté. Du sol au lockout en un geste, punch en fin de trajectoire."},
  ...
  {id:"kb15",n:"Complex KB Swing+Clean+Press",m:"Full body",eq:"kb",kg:14,reps:"5",rest:120,rpe:9,cue:"Une main, tour complet puis on change. Swing+Clean+Press = 1 rep. Qualité avant vitesse."},
  ...
  {id:"x171",n:"Kettlebell Complex",m:"Full body · Cardio",eq:"kb",kg:16,reps:"5x3",rest:120,rpe:9,cue:"Une main, on change de côté à chaque tour. Clean-squat-press enchaînés sans poser."},
